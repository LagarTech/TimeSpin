...
public class PlayerMovement : NetworkBehaviour
{
    ...
    private void Update()
    {
        ...
        // El Host debe realizar ambas funcionalidades
        if (IsServer)
        {
    ...
    private void GetCurrentScene()
    {
        ...
        switch (sceneName)
        {
            case "LobbyMenu":
                ...
                if (IsOwner)
                {
                    ...
                    transform.position = _startingPositionsLobby[(int)OwnerClientId];
            ...
            case "Egipt":
                ...
                if (IsOwner)
                {
                    transform.position = _startingPositionsEgipt[(int)OwnerClientId];
                }
                break;
            case "Medieval":
            ...
            case "Maya":
                ...
                {
                    // Se debe colocar al jugador en la posición de inicio adecuada
                    transform.position = _startingPositionsMaya[(int)OwnerClientId];
            ...
            case "Future":
                ...
                {
                    // Se debe colocar al jugador en la posición de inicio adecuada
                    transform.position = _startingPositionsFuture[(int)OwnerClientId];
                }
        ...
        // Se inicia la pantalla de carga, sólo el dueño del jugador principal
        if (IsOwner)
        {
