...
public class StartingManager : NetworkBehaviour
{
    ...
    [SerializeField] private int[] _selectedGames = new int[5];
    ...
    private void UpdatePlayersCount()
    {
        if (IsHost)
        {
            // Contabiliza cuántos jugadores hay conectados
            ...
            // Si hay más jugadores que los requeridos (2), se muestra el botón de comenzar
    ...
    private void GameSelectionServerRpc(int idGame)
    {
        ...
        if (_numSelections == _numPlayers)
        {
            ...
            // Se comienza la transición de escena
            LoadingScreenManager.instance.ServerSceneTransition(nextGameScene);
        }
    }
}
